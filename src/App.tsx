...
function App() {
    ...
    useEffect(() => {
        ...
        if (authed) {
            subscription = Account.getInstance()
                .auth()
                .subscribe({
                    error: (e) => {
                        setState({
    ...
    return (
        <div>
            ...
            <Box
                className={
                    'h-screen w-screen my-auto mx-auto relative flex items-center bg-gray-100'
                }>
                <Box
                    sx={{
                        position: 'absolute',
                ...
                <Router>
                    <Box
                        className={
                            'mx-auto my-auto items-center flex  w-full h-full '
                        }
                        zIndex={1}>
                        {state.isLoading ? (
                            <Loading />
