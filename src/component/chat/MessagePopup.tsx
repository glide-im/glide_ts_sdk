    ...
    return (
        <>
            <Menu
                ...
                anchorPosition={
                    location !== null
                        ? { top: location.mouseY, left: location.mouseX }
                        : undefined
                }
                ref={menuRef}
                id='menu-appbar'
                ...
                onClose={handleClose}>
                {props.msg.FromMe ? (
                    <MenuItem disabled onClick={handleRevoke}>
                        <Box mx={1}>撤回</Box>
                    </MenuItem>
                ) : null}
                <MenuItem disabled onClick={handleForward}>
                    <Box mx={1}>转发</Box>
                </MenuItem>
            ...
            <Box
                ...
                bgcolor={location !== null ? 'rgba(65,65,65,0.15)' : ''}
                width={'100%'}>
                {props.children}
            </Box>
        </>
