...
export class Peer {
    ...
    private init() {
        ...
        this.connection.onicecandidate = (event: RTCPeerConnectionIceEvent) => {
            ...
            this.signaling.sendSignaling(this.peerId, SignalingType.RtcCandidate, {
                id: this.peerId,
        ...
        this.signaling.addMessageListener((msg: SignalingMessage) => {
            switch (msg.type) {
                case SignalingType.RtcOffer:
                    ...
                    this.sendAnswer(offer.sdp).then(() => {
    ...
    public async sendAnswer(remote: RTCSessionDescriptionInit) {
        ...
        this.connection!.createAnswer()
            .then(answer => {
                ...
                return this.signaling.sendSignaling(this.peerId, SignalingType.RtcAnswer, cnt);
            }).then(() => {
    ...
    public sendOffer() {
        ...
        this.connection.createOffer()
            .then(async offer => {
                ...
                return this.signaling.sendSignaling(this.peerId, SignalingType.RtcOffer, cnt);
            }).then(() => {
